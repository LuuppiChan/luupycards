...
class Ui_Luupycards(object):
    def setupUi(self, Luupycards):
        ...
        self.pushButton_delete_row = QPushButton(self.tab_inspector)
        self.pushButton_delete_row.setObjectName(u"pushButton_delete_row")

        self.horizontalLayout_10.addWidget(self.pushButton_delete_row)

        self.pushButton_new_row = QPushButton(self.tab_inspector)
        self.pushButton_new_row.setObjectName(u"pushButton_new_row")

        self.horizontalLayout_10.addWidget(self.pushButton_new_row)
    ...
    def retranslateUi(self, Luupycards):
        ...
        self.actionNew_file.setIconText(QCoreApplication.translate("Luupycards", u"Create a new pair file", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.pushButton_delete_row.setToolTip(QCoreApplication.translate("Luupycards", u"Removes a row from the end of the list", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.pushButton_delete_row.setStatusTip(QCoreApplication.translate("Luupycards", u"Removes a row from the end of the list", None))
#endif // QT_CONFIG(statustip)
        self.pushButton_delete_row.setText(QCoreApplication.translate("Luupycards", u"Delete row", None))
#if QT_CONFIG(tooltip)
        self.pushButton_new_row.setToolTip(QCoreApplication.translate("Luupycards", u"Adds a new row at the end of the list", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.pushButton_new_row.setStatusTip(QCoreApplication.translate("Luupycards", u"Adds a new row at the end of the list", None))
#endif // QT_CONFIG(statustip)
        self.pushButton_new_row.setText(QCoreApplication.translate("Luupycards", u"New row", None))
