...
#if QT_CONFIG(tooltip)
        self.actionRegEx_support.setToolTip(QCoreApplication.translate("Luupycards", u"Enable RegEx support for answer matching.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        self.actionRegEx_support.setStatusTip(QCoreApplication.translate("Luupycards", u"Enable RegEx support for answer matching.", None))
#endif // QT_CONFIG(statustip)
